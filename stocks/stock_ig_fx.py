...
buy_price = 26.29                   #######################  INPUT BUY PRICE HERE
sell_price = 26.27                  #######################  INPUT SELL PRICE HERE

shares_amount = 10 #input or based on availible funds ###### INPUT SHARES AMOUNT HERE
...
fx_cost = (share_cost_buy_sell_fee + tax_cost + spread_cost) /100 * ex_rate
print("cost to buy fx £"+str(fx_cost))  


total = share_cost_buy_sell_fee + tax_cost + spread_cost + fx_cost
...
all_charges = buy_sell_fee *2 +spread_cost + tax_cost + monthly_fee + fx_cost
print("All charges to trade £"+str(all_charges))
cost_to_buy = tax_cost + share_cost_buy_sell_fee + monthly_fee + buy_sell_fee + spread_cost + fx_cost
...
print("\n")
print("Profit loss")
sell_price_out = 28.50  # later input or API#######################  INPUT SELL PRICE HERE
print("Sell price: £" + str(sell_price_out))


fx_out = ((sell_price_out - break_even_price) * shares_amount) / 100 * ex_rate
#print("FX out £" + str(fx_out))

profit_loss = (sell_price_out - break_even_price) * shares_amount - fx_out
